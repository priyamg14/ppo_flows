...
class lorenz(gym.Env):
    ...
    def __init__(self, cpu=0,
        ...
        high = np.ones((self.n_obs))#.reshape((1,self.n_obs))
    ...
    def step(self, u=None):
        ...
        # Check the observation shape and type
        # assert obs.shape == (1, 6), f"Observation shape mismatch: {obs.shape}"
    ...
    def solve(self, u=None):
        ...
        if (u is None): u = copy.copy(self.u)
